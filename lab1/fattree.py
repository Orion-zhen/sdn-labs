...
class FatTree(Topo):
    ...
    def build(self):
        ...
        self.addLink(aggr1_1, core3)
        self.addLink(aggr1_1, core4)
        self.addLink(aggr1_2, core1)
        self.addLink(aggr1_2, core2)
        self.addLink(aggr1_2, core3)
        self.addLink(aggr1_2, core4)
        
        self.addLink(aggr2_1, core1)
        self.addLink(aggr2_1, core2)
        self.addLink(aggr2_1, core3)
        self.addLink(aggr2_1, core4)
        self.addLink(aggr2_2, core1)
        self.addLink(aggr2_2, core2)
        self.addLink(aggr2_2, core3)
        self.addLink(aggr2_2, core4)
        
        self.addLink(aggr3_1, core1)
        self.addLink(aggr3_1, core2)
        self.addLink(aggr3_1, core3)
        self.addLink(aggr3_1, core4)
        self.addLink(aggr3_2, core1)
        self.addLink(aggr3_2, core2)
        self.addLink(aggr3_2, core3)
        self.addLink(aggr3_2, core4)
    
        self.addLink(aggr4_1, core1)
        self.addLink(aggr4_1, core2)
        self.addLink(aggr4_1, core3)
        self.addLink(aggr4_1, core4)
        self.addLink(aggr4_2, core1)
        self.addLink(aggr4_2, core2)
